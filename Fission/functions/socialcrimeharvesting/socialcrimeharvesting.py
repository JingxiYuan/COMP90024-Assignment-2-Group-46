...
def main():
    ...
    social_crime_response = social_mast.timeline_hashtag(hashtag="crime", limit=40)
    ...
    current_app.logger.info(f"Harvested {len(upload)} From Mastodon's social crime server")
